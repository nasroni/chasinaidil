...
///
/// The [MyCupertinoSliverNavigationBar] must be placed in a sliver group such
...
/// behavior for multiple navigation bars per route.
///
/// [MyCupertinoSliverNavigationBar] has its text scale factor set to 1.0 by default
...
/// [MyCupertinoSliverNavigationBar]'s components inside a [MediaQuery] with the
...
///
/// {@tool dartpad}
/// This example shows [MyCupertinoSliverNavigationBar] in action inside a [CustomScrollView].
///
...
class MyCupertinoSliverNavigationBar extends StatefulWidget {
  ...
  @override
  State<MyCupertinoSliverNavigationBar> createState() =>
      _MyCupertinoSliverNavigationBarState();
}

// A state class exists for the nav bar so that the keys of its sub-components
// don't change when rebuilding the nav bar, causing the sub-components to
// lose their own states.
class _MyCupertinoSliverNavigationBarState
    extends State<MyCupertinoSliverNavigationBar> {
  late _NavigationBarStaticComponentsKeys keys;
...
///
/// Magnifies on over-scroll when [MyCupertinoSliverNavigationBar.stretch]
/// parameter is true.
...
class _RenderLargeTitle extends RenderShiftedBox {
  ...
  void performLayout() {
    ...
    final BoxConstraints childConstriants =
